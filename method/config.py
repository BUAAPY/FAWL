...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--model_name", type=str, default='FAWL')
        ...
        self.parser.add_argument("--alpha4", type=float, default=1, help="weight for saliency loss")
        self.parser.add_argument("--alpha5", type=float, default=1, help="weight for boundary loss")
        ...
        self.parser.add_argument("--warmup_epoch", type=int, default=7)
